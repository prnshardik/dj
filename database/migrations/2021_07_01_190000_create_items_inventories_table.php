...
class CreateItemsInventoriesTable extends Migration
{
    ...
    public function up()
    {
        ...
        if(file_exists(public_path('/qr_logo.png')) && !file_exists(public_path('/uploads/items_inventory/default.png')) ){
            File::copy(public_path('/qr_logo.png'), public_path('/uploads/items_inventory/default.png'));
        }
    }
