        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Items Inventories
                        <a class="btn btn-primary btn-sm pull-right ml-2" style="margin-top: 8px;margin-bottom: 5px" href="{{ route('items.inventories.create') }}">Add New</a>
                    </h5>
                </div>
                <div class="card-body">
...
@section('scripts')
    <script type="text/javascript">
        ...
        function change_status(object){
            ...
            if (confirm(msg)) {
                $.ajax({
                    "url": "{!! route('items.inventories.change.status') !!}",
                    "dataType": "json",
                    "type": "POST",
                    "data":{
                        id: id,
